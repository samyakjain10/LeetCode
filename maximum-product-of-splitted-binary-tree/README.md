<h2>1339. Maximum Product of Splitted Binary Tree</h2><h3>Medium</h3><hr><div><p>Given the <code>root</code> of a binary tree, split the binary tree into two subtrees by removing one edge such that the product of the sums of the subtrees is maximized.</p>
